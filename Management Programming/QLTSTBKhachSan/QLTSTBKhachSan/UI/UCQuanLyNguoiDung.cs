    ...
    public partial class UCQuanLyNguoiDung : UserControl
    {
        ...
        private void btnAddUser_Click(object sender, EventArgs e)
        {
            if (pnAddUser.Visible == false)
            {
                ...
                btnAddUser.Image = Image.FromFile(@"C:\Users\PC GAMING\Desktop\IT\QLTSTBKhachSan\Management Programming\Img\minus_24px.png");
            }
            else
            {
                pnAddUser.Visible = false;
                btnAddUser.Image = Image.FromFile(@"C:\Users\PC GAMING\Desktop\IT\QLTSTBKhachSan\Management Programming\Img\add_32px.png");
            }
        }
